...
In this article, we will show you how to plot a figure with multiple histograms by using [**ggplot2**](https://ggplot2.tidyverse.org/) and [**ggpubr**](https://cran.r-project.org/package=ggpubr) packages. 
